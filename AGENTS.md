...
- Alpha (transparent ProRes 4444 .mov) is the default render mode; opaque renders are H.264 .mp4 filled with the theme background. Frame width/height must stay even for yuv420p.
